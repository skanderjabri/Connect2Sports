                    ...
                    <View style={styles.contentContainer}>
                        ...
                        <View style={styles.joinContainer}>
                            <TouchableOpacity
                                ...
                                onPress={() => router.push(`/ConfirmationSalle/${SalleID}`)}
                            >
                                <View style={styles.joinContent}>
                                    <FontAwesome name="star" size={24} color="#FF8C00" />
                                    <Text style={styles.joinText}>Rejoindre notre salle</Text>
                                    <FontAwesome name="arrow-right" size={24} color="#FF8C00" />
                                </View>
                            </TouchableOpacity>
                        </View>
                        {/* Section: Horaires */}
...
const styles = StyleSheet.create({
    ...
    joinText: {
        color: '#FF8C00', // Orange text instead of white
        fontSize: 20,
        fontFamily: "Sen-Bold",
        textAlign: 'center',
        flex: 1,
