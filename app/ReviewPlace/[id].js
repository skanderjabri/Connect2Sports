...
import CreateReviewPlaceApi from "../../api/CreateReviewPlaceApi";
import GetAllReviewsByPlaceApi from "../../api/GetAllReviewsByPlaceApi";
export default function ReviewPlace() {
    ...
    const fetechReviews = () => {
        return GetAllReviewsByPlaceApi(id)
    ...
    const handleCreateReview = async () => {
        ...
        try {
            ...
            const response = await CreateReviewPlaceApi(user, id, rating, comment);
